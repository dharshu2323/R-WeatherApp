...
ui<- fluidPage(theme = shinytheme('united'),
               ...
               sidebarPanel(
                 ...
                 selectInput("outlook",label='Outlook:',choices=list("Sunny"="sunny","Overcast"="overcast","Rainy"="rainy"),selected = "Rainy"),
                 
                 sliderInput("temperature","Temperature:",
                             min=64,max=86,value=70),
                 sliderInput("humidity","Humidity:",min=65,max=96,value=90),
                 selectInput("windy","Windy:",choices=list("Yes"="True","No"="FALSE"),
                             selected="TRUE"),
